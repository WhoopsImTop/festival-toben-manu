<template>
  <div class="content-container">
    ...
    <p>
      Telefon: 015233592058<br />
      E-Mail: eliasenglen2@gmail.com
    </p>
    <p>
    ...
    <p>
      ...
      Usercentrics GmbH, Sendlinger Stra&szlig;e 7, 80331 M&uuml;nchen, Website:
      <a
    ...
    <p>
      ...
      die erteilten Einwilligungen bzw. deren Widerruf zuordnen zu k&ouml;nnen.
      Die so erfassten Daten werden gespeichert, bis Sie uns zur L&ouml;schung
      auffordern, das Usercentrics-Cookie selbst l&ouml;schen oder der Zweck
      f&uuml;r die Datenspeicherung entf&auml;llt. Zwingende gesetzliche
      Aufbewahrungspflichten bleiben unber&uuml;hrt.
    </p>
    <p>
      Das Usercentrics-Banner auf dieser Website wurde mit Hilfe von eRecht24
      konfiguriert. Das erkennen Sie daran, dass im Banner das Logo von eRecht24
      auftaucht. Um das eRecht24-Logo im Banner auszuspielen, wird eine
      Verbindung zum Bildserver von eRecht24 hergestellt. Hierbei wird auch die
      IP-Adresse &uuml;bertragen, die jedoch nur in anonymisierter Form in den
      Server-Logs gespeichert wird. Der Bildserver von eRecht24 befindet sich in
      Deutschland bei einem deutschen Anbieter. Das Banner selbst wird
    ...
    <h3>
      Daten&shy;&uuml;bermittlung bei Vertragsschluss f&uuml;r Online-Shops,
      H&auml;ndler und Warenversand
    </h3>
    <p>
      ...
      gestattet. Sofern Sie eine entsprechende Einwilligung nach Art. 6 Abs. 1
      lit. a DSGVO erteilt haben, werden wir Ihre E-Mail-Adresse an das mit der
      Lieferung betraute Transportunternehmen &uuml;bergeben, damit dieses Sie
      per E-Mail &uuml;ber den Versandstatus Ihrer Bestellung informieren kann;
    ...
    <h4>PayPal</h4>
    <p>
      Anbieter dieses Zahlungsdienstes ist PayPal (Europe) S.&agrave;.r.l. et
